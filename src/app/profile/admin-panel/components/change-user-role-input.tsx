...
export const ChangeUserRoleInput = ({
  ...
  return (
    <select
      ...
      className="w-full rounded border border-gray-200 bg-white px-2 py-1 leading-tight 
      focus:border-gray-500 focus:outline-none disabled:opacity-50"
    >
...
// STEP BY STEP TO CREATING FUNCTIONS LIKE THIS INDEPENDENTLY

// 1) declare the function
// 2) declare the types the function will accept
